...
export async function GET(req: NextRequest) {
    ...
    try { 
        ...
        console.log('Running update eu shuffle forth quarter');
        await updateShuffle('eu', 4)
        
        console.log('Finished updating eu shuffle');
        return NextResponse.json({ message: 'Finished updating eu shuffle forth quarter' });
    } catch (error) {
